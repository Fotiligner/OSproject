...
class FileTab(QWidget):
    def __init__(self,file_module,file_signal,parent=None):
        ...
        self.algo_combox.addItems(['FCFS','SSTF'])
        ...
        self.row2_table_widget.setHorizontalHeaderLabels([u'扇区'+str(i) for i in range(self.file_module.disk.sector_per_track)])
        self.row2_table_widget.setVerticalHeaderLabels([u'磁道'+str(i) for i in range(self.file_module.disk.track_tot_num)])
